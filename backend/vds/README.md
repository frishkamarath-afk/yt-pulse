...
- принимает heartbeat активных сессий и позволяет завершить конкретную установку по `installId`;
...
- не собирает скриншоты, имя Windows-пользователя, MAC-адрес, серийники, список файлов или токены.
