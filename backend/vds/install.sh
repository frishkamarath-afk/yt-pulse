...
YT_VALHALLA_ALLOWED_ORIGINS=https://frishkamarath-afk.github.io
YT_VALHALLA_ALLOW_ANY_HTTPS_ORIGIN=true
YT_VALHALLA_TELEGRAM_BOT_TOKEN=${TELEGRAM_BOT_TOKEN:-}
YT_VALHALLA_TELEGRAM_ADMIN_CHAT_ID=${TELEGRAM_ADMIN_CHAT_ID:-}
YT_VALHALLA_TELEGRAM_MODERATOR_CHAT_ID=${TELEGRAM_MODERATOR_CHAT_ID:-}
YT_VALHALLA_TELEGRAM_ADMIN_USERNAME=${TELEGRAM_ADMIN_USERNAME:-zzshka_dz}
YT_VALHALLA_TELEGRAM_MODERATOR_USERNAME=${TELEGRAM_MODERATOR_USERNAME:-STEPASHIK1}
